...
$doc -> addStyleSheet(TZ_Portfolio_PlusUri::base(true).'/templates/'.$tzTemplate -> template.'/css/photoswipe/photoswipe.css');
$doc -> addStyleSheet(TZ_Portfolio_PlusUri::base(true).'/templates/'.$tzTemplate -> template.'/css/photoswipe/default-skin/default-skin.css');
$doc -> addScript(TZ_Portfolio_PlusUri::base(true).'/templates/'.$tzTemplate -> template.'/js/photoswipe.min.js');
$doc -> addScript(TZ_Portfolio_PlusUri::base(true).'/templates/'.$tzTemplate -> template.'/js/photoswipe-ui-default.min.js');
$doc -> addScript(TZ_Portfolio_PlusUri::base(true).'/templates/'.$tzTemplate -> template.'/js/template.min.js');
$doc -> addScript(TZ_Portfolio_PlusUri::base(true).'/templates/'.$tzTemplate -> template.'/js/lightbox.min.js');
...
<?php if($this -> items):?>
    ...
    $params = &$this -> params;
?>
<div id="tpPortfolio" class="tplBesley tzpp_bootstrap3 <?php echo $this->pageclass_sfx;?>">
