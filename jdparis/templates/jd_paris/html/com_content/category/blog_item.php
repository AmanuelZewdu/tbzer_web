      ...
      <?php if ($template->params->get('astroid_badge', 1)) { ?>
         <?php if ($astroidArticle->article->params->get('astroid_article_badge', 0)) { ?>
            ...
            if ($astroidArticle->article->params->get('astroid_article_badge_type', 2) == 1) {
               $style = '.article-badge.article-badge-1:after{ border-left-color: ' . $astroidArticle->article->params->get('astroid_article_badge_color', '#000') . '; }';
               $document->addStyleDeclaration($style);
               ?>
               <div style="background: <?php echo $astroidArticle->article->params->get('astroid_article_badge_color', '#000'); ?>" class="article-badge article-badge-<?php echo $astroidArticle->article->params->get('astroid_article_badge_type', 2); ?>"><?php echo JText::_($astroidArticle->article->params->get('astroid_article_badge_text', '')); ?></div>
            <?php } else { ?>
